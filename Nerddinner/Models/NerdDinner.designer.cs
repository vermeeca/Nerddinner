...
namespace Nerddinner.Models
{
    ...
    partial void OnLongitudeChanged();
		...
		[Column(Storage="_HostedBy", DbType="NVarChar(20) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ContactPhone", DbType="NVarChar(20) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Country", DbType="NVarChar(30) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Dinner_RSVP", Storage="_RSVPs", OtherKey="DinnerID")]
    ...
    partial void OnAttendeeNameChanged();
		...
		[Column(Storage="_AttendeeName", DbType="NVarChar(50)")]
		...
		[Association(Name="Dinner_RSVP", Storage="_Dinner", ThisKey="DinnerID", IsForeignKey=true)]
